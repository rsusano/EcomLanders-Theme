# Trust signals and compliance for health claims
...
**Trust signals and compliance for health claims**: translate the checklist below into concrete Theme Editor choices, metafields, and section blocks so the PDP story stays consistent from ad click to order confirmation.
