# Server-side vs client-side variant changes
...
**Server-side vs client-side variant changes**: translate the checklist below into concrete Theme Editor choices, metafields, and section blocks so the PDP story stays consistent from ad click to order confirmation.
