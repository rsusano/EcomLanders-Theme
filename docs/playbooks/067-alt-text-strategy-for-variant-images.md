# Alt text strategy for variant images
...
**Alt text strategy for variant images**: translate the checklist below into concrete Theme Editor choices, metafields, and section blocks so the PDP story stays consistent from ad click to order confirmation.
